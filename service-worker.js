const CACHE_NAME = "korklar-sample-v73";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=73",
  "./data/batch1-raw.js?v=73",
  "./data/batch1-ar.js?v=73",
  "./data/batch1-review-ar.js?v=73",
  "./data/remaining-enriched.js?v=73",
  "./data/resolved-review.js?v=73",
  "./data/prov1-gpt-ar.js?v=73",
  "./data/prov2-gpt-ar.js?v=73",
  "./data/rules100-gpt-ar.js?v=73",
  "./data/cleanup-reviewed-ar.js?v=73",
  "./data/sample-ten-ar.js?v=73",
  "./app.js?v=73",
  ...
  "./assets/custom-overtake-left-blinker.webp",
