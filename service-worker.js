const CACHE_NAME = "korklar-sample-v23";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=23",
  "./data/batch1-raw.js?v=23",
  "./data/batch1-ar.js?v=23",
  "./data/batch1-review-ar.js?v=23",
  "./data/remaining-enriched.js?v=23",
  "./data/resolved-review.js?v=23",
  "./data/prov1-gpt-ar.js?v=23",
  "./data/prov2-gpt-ar.js?v=23",
  "./data/rules100-gpt-ar.js?v=23",
  "./app.js?v=23",
