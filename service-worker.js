const CACHE_NAME = "korklar-sample-v53";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=53",
  "./data/batch1-raw.js?v=53",
  "./data/batch1-ar.js?v=53",
  "./data/batch1-review-ar.js?v=53",
  "./data/remaining-enriched.js?v=53",
  "./data/resolved-review.js?v=53",
  "./data/prov1-gpt-ar.js?v=53",
  "./data/prov2-gpt-ar.js?v=53",
  "./data/rules100-gpt-ar.js?v=53",
  "./data/cleanup-reviewed-ar.js?v=53",
  "./app.js?v=53",
