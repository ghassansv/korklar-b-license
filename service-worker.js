const CACHE_NAME = "korklar-sample-v28";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=28",
  "./data/batch1-raw.js?v=28",
  "./data/batch1-ar.js?v=28",
  "./data/batch1-review-ar.js?v=28",
  "./data/remaining-enriched.js?v=28",
  "./data/resolved-review.js?v=28",
  "./data/prov1-gpt-ar.js?v=28",
  "./data/prov2-gpt-ar.js?v=28",
  "./data/rules100-gpt-ar.js?v=28",
  "./app.js?v=28",
