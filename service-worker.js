const CACHE_NAME = "korklar-sample-v47";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=47",
  "./data/batch1-raw.js?v=47",
  "./data/batch1-ar.js?v=47",
  "./data/batch1-review-ar.js?v=47",
  "./data/remaining-enriched.js?v=47",
  "./data/resolved-review.js?v=47",
  "./data/prov1-gpt-ar.js?v=47",
  "./data/prov2-gpt-ar.js?v=47",
  "./data/rules100-gpt-ar.js?v=47",
  "./data/cleanup-reviewed-ar.js?v=47",
  "./app.js?v=47",
