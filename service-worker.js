const CACHE_NAME = "korklar-sample-v62";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=62",
  "./data/batch1-raw.js?v=62",
  "./data/batch1-ar.js?v=62",
  "./data/batch1-review-ar.js?v=62",
  "./data/remaining-enriched.js?v=62",
  "./data/resolved-review.js?v=62",
  "./data/prov1-gpt-ar.js?v=62",
  "./data/prov2-gpt-ar.js?v=62",
  "./data/rules100-gpt-ar.js?v=62",
  "./data/cleanup-reviewed-ar.js?v=62",
  "./data/sample-ten-ar.js?v=62",
  "./app.js?v=62",
