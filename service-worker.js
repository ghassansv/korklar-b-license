const CACHE_NAME = "korklar-sample-v56";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=56",
  "./data/batch1-raw.js?v=56",
  "./data/batch1-ar.js?v=56",
  "./data/batch1-review-ar.js?v=56",
  "./data/remaining-enriched.js?v=56",
  "./data/resolved-review.js?v=56",
  "./data/prov1-gpt-ar.js?v=56",
  "./data/prov2-gpt-ar.js?v=56",
  "./data/rules100-gpt-ar.js?v=56",
  "./data/cleanup-reviewed-ar.js?v=56",
  "./data/sample-ten-ar.js?v=56",
  "./app.js?v=56",
