const CACHE_NAME = "korklar-sample-v31";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=31",
  "./data/batch1-raw.js?v=31",
  "./data/batch1-ar.js?v=31",
  "./data/batch1-review-ar.js?v=31",
  "./data/remaining-enriched.js?v=31",
  "./data/resolved-review.js?v=31",
  "./data/prov1-gpt-ar.js?v=31",
  "./data/prov2-gpt-ar.js?v=31",
  "./data/rules100-gpt-ar.js?v=31",
  "./app.js?v=31",
