...
const ASSETS = [
  ...
  "./index.html",
  "./styles.css?v=30",
  "./data/batch1-raw.js?v=30",
  "./data/batch1-ar.js?v=30",
  "./data/batch1-review-ar.js?v=30",
  "./data/remaining-enriched.js?v=30",
  "./data/resolved-review.js?v=30",
  "./data/prov1-gpt-ar.js?v=30",
  "./data/prov2-gpt-ar.js?v=30",
  "./data/rules100-gpt-ar.js?v=30",
  "./app.js?v=30",
