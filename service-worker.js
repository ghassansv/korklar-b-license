const CACHE_NAME = "korklar-sample-v27";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=27",
  "./data/batch1-raw.js?v=27",
  "./data/batch1-ar.js?v=27",
  "./data/batch1-review-ar.js?v=27",
  "./data/remaining-enriched.js?v=27",
  "./data/resolved-review.js?v=27",
  "./data/prov1-gpt-ar.js?v=27",
  "./data/prov2-gpt-ar.js?v=27",
  "./data/rules100-gpt-ar.js?v=27",
  "./app.js?v=27",
