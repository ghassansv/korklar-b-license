const CACHE_NAME = "korklar-sample-v69";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=69",
  "./data/batch1-raw.js?v=69",
  "./data/batch1-ar.js?v=69",
  "./data/batch1-review-ar.js?v=69",
  "./data/remaining-enriched.js?v=69",
  "./data/resolved-review.js?v=69",
  "./data/prov1-gpt-ar.js?v=69",
  "./data/prov2-gpt-ar.js?v=69",
  "./data/rules100-gpt-ar.js?v=69",
  "./data/cleanup-reviewed-ar.js?v=69",
  "./data/sample-ten-ar.js?v=69",
  "./app.js?v=69",
